  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100 py-10">
      <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
        <h2 className="text-2xl font-bold mb-6 text-center text-green-600">Faculty Registration</h2>
        {error && <p className="text-red-500 mb-4 text-sm text-center">{error}</p>}
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-sm font-medium mb-1">Select Institute</label>
            <select name="institute_id" required className="w-full border rounded p-2 focus:outline-green-500" onChange={handleInstituteChange}>
          ...
          <div>
            ...
            <select name="department_id" required className="w-full border rounded p-2 focus:outline-green-500" onChange={handleChange} value={formData.department_id} disabled={!formData.institute_id}>
          ...
          <div>
            ...
            <input type="email" name="email" required className="w-full border rounded p-2 focus:outline-green-500" onChange={handleChange} />
          </div>
          <div>
            <label className="block text-sm font-medium mb-1">Mobile Number (10 digits)</label>
            <input name="mobile_number" required className="w-full border rounded p-2 focus:outline-green-500" onChange={handleChange} />
          </div>
          <div>
            <label className="block text-sm font-medium mb-1">Password</label>
            <input type="password" name="password" required className="w-full border rounded p-2 focus:outline-green-500" onChange={handleChange} />
        ...
        <div className="mt-4 text-sm text-center">
          <Link to="/login" className="text-green-500 hover:underline">Back to Login</Link>
        </div>
      </div>
    </div>
  );
